...
const Info: FC<InfoProps> = ({ onNext }) => {
  return (
    <Box style={styles.contentBox}>
      <Box style={styles.smallBar} />
      <Text style={styles.title}>Confirm your Information</Text>
      <Text style={styles.subtitle}>Verify your details before proceeding</Text>

      <Box style={styles.infoWrapper}>
        <Box style={styles.infoInputWrapper}>
          <input type="text" placeholder="First Name" style={styles.textField} />
        </Box>
        <Box style={styles.infoInputWrapper}>
          <input type="text" placeholder="Last Name" style={styles.textField} />
        </Box>
      </Box>

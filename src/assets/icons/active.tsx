  ...
  >
    <g className="active-outline">
      <g fill="currentColor" fillRule="evenodd" className="Vector" clipRule="evenodd">
        ...
        <path d="M16.696 9.282a1 1 0 0 1 .022 1.414L12.16 15.4a1.4 1.4 0 0 1-2.01 0l-1.867-1.926a1 1 0 0 1 1.436-1.392l1.436 1.481l4.128-4.259a1 1 0 0 1 1.414-.022Z"/>
      </g>
    </g>
  </svg>
);
